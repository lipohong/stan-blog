...
const CONTENT_TYPE_CONFIG = {
  article: {
    ...
    defaultDescription: 'Read this article on Stan Blog',
  },
  plan: {
    section: 'Plans',
    defaultKeywords: 'blog, plan, learning, growth, goals',
    defaultDescription: 'View this plan on Stan Blog',
  },
  vocabulary: {
    section: 'Vocabularies',
    defaultKeywords: 'blog, vocabulary, learning, language, words',
    defaultDescription: 'Explore this vocabulary collection on Stan Blog',
  },
  collection: {
    section: 'Collections',
    defaultKeywords: 'blog, collection, learning, resources',
    defaultDescription: 'Explore this collection on Stan Blog',
  },
  profile: {
    section: 'Profile',
    defaultKeywords: 'profile, user, blog, learning, growth',
    defaultDescription: 'View this user profile on Stan Blog',
  },
};
...
export function useSEO({ content, profile, contentType, defaultDescription, defaultKeywords }: UseSEOProps): SEOData | null {
  return useMemo(() => {
    ...
    const baseStructuredData = {
      title: content.title,
      description: description,
      author: content.ownerName ?? 'Stan Blog',
