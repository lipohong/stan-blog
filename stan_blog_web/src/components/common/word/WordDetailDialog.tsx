...
interface WordDetailDialogProps {
  readonly word: IWordGeneralDTO | null;
  readonly setWord: (word: IWordGeneralDTO | null) => void;
  readonly loadData: (vocabularyId: string) => void;
  readonly handleDeleteWord: (wordId: number) => void;
}
        ...
        >
          ...
          <DialogContent>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
              <Button onClick={() => props.handleDeleteWord?.(props.word?.id ?? 0)}>{t('word-dialog.delete')}</Button>
              <Button
                onClick={handleSave}
                variant="contained"
              >
