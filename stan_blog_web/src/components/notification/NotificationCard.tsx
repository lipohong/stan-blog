import { ListItem, ListItemText, Box, Typography, useTheme, Divider } from '@mui/material';
...
export default function NotificationCard({ notification, onMarkAsRead }: INotificationCardProps) {
  ...
  const handleDetailClick = useCallback(() => {
    if (notification.actionUrl) {
      ...
      window.open(`${import.meta.env.BASE_URL?.replace(/\/$/, '')}/${notification.actionUrl?.replace(/^\//, '')}`, '_blank');
    }
  }, [notification.actionUrl, onMarkAsRead, notification.id]);
