import { Box, Typography, Avatar, Card, CardContent, useTheme, Button, Chip, Tooltip, IconButton, Divider } from '@mui/material';
import { Block as BlockIcon, CheckCircle as CheckCircleIcon, Star as StarIcon, StarBorder as StarBorderIcon, Launch as LaunchIcon } from '@mui/icons-material';
...
export default function ContentDetailDrawer({ open, onClose, content, onBan, onUnban, onRecommend, onUnrecommend }: IContentDetailDrawerProps) {
