...
export default function CommentForm({ contentId, contentType, parentId, placeholder, onCommentCreated, onCancel }: CommentFormProps) {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const successMessage = parentId ? t('comments.actions.reply-success') : t('comments.actions.create-success');
