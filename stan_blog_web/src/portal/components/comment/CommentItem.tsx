...
export default function CommentItem({ comment, onCommentDeleted, onReplyCreated }: CommentItemProps) {
  ...
  const handleLike = async () => {
    ...
    try {
      ...
      const message = newLiked ? t('comments.actions.like-success') : t('comments.actions.unlike-success');
