...
public interface CommentMapper extends BaseMapper<CommentEntity> {
     ...
     */
    @Update("UPDATE stan_blog_comment SET like_count = like_count + 1 WHERE id = #{id}")
     ...
     * @return affected rows
     */
    @Update("UPDATE stan_blog_comment SET like_count = like_count - 1 WHERE id = #{id} AND like_count > 0")
