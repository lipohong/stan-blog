...
CREATE TABLE IF NOT EXISTS `stan_blog_comment` (
    ...
    `content_id` VARCHAR(32) NOT NULL COMMENT 'Content ID that this comment belongs to',
    ...
    `like_count` BIGINT NOT NULL DEFAULT 0 COMMENT 'Number of likes for this comment',
...
CREATE TABLE IF NOT EXISTS `stan_blog_notification` (
    ...
    `metadata` VARCHAR(2000) COMMENT 'Additional metadata for the notification',
    `create_time` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT 'Create time',
    `create_by` VARCHAR(30) DEFAULT NULL COMMENT 'Creator',
    `update_time` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT 'Update time',
    `update_by` VARCHAR(30) DEFAULT NULL COMMENT 'Updater',
