...
import static com.stan.blog.DefaultTestData.DefaultUser.COLLECTION_MODULE;
import static com.stan.blog.DefaultTestData.DefaultUser.PLAN_MODULE;
import static com.stan.blog.DefaultTestData.DefaultUser.VOCABULARY_MODULE;
import com.stan.blog.beans.consts.Const.Role;
...
public class UserServiceTests {
    ...
    public void testCreateUser_saveWithCorrectInput() {
        ...
        dto.setEmail("bob.pop@gmail.com");
        dto.setLastName("bob");
    ...
    public void testCreateUser_duplicatedEmailIsNotAllow() {
        UserCreationDTO dto = new UserCreationDTO();
        dto.setEmail("duplicat_testing@gmail.com");
        dto.setPassword("123456");
        // The user should be saved successfully
        userService.createUser(dto);

        // DuplicateKeyException should be throw when executing the same request again
        Assertions.assertThrows(StanBlogRuntimeException.class, () -> userService.createUser(dto));
    }
    ...
    public void testCreateUser_badInputIsNotAllow() {
        ...
        dtoWithNullPassword.setEmail("no_password@gmail.com");
        ...
        dtoWithLongFirstName.setEmail("longFirstName@gmail.com");
        ...
        dtoWithLongLastName.setEmail("longLastName@gmail.com");
        ...
        dtoWithLongEmail.setEmail(RandomStringUtils.randomAlphabetic(65) + "@gmail.com");
        ...
        dtoWithLongEmail.setEmail(RandomStringUtils.randomAlphabetic(64) + "@gmail.com");
        ...
        dtoWithLongPw.setEmail("longPw@gmail.com");
    ...
    public void testUpdateUser_existingUserCanBeUpdated() {
        ...
        dto.setEmail("user-to-be-updated@gmail.com");
        dto.setPassword("123456");
        ...
        updateDTO.setEmail("user-updated@gmail.com");
        ...
        Assertions.assertEquals("user-updated@gmail.com", updatedUser.getEmail());
    ...
    public void testDeleteUser_deleteExistingUser() {
        final UserCreationDTO dto = new UserCreationDTO();
        dto.setEmail("user-to-be-deleted@gmail.com");
        dto.setPassword("123456");
        UserGeneralDTO createdUser = userService.createUser(dto);
